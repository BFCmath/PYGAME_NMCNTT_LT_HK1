...
class MenuVisual:
    ...
    def _draw_button(self, rect, text, size):
    ...
    def draw_menu(self):
        self._draw_button(Menu.TITLE_RECT, Menu.TITLE_TEXT,Menu.TITLE_TEXT_SIZE)
        self._draw_button(Menu.PLAY_BUTTON_RECT, Menu.PLAY_TEXT,Menu.PLAY_BUTTON_SIZE)
        self._draw_button(Menu.SETTINGS_BUTTON_RECT, Menu.SETTINGS_TEXT,Menu.SETTINGS_BUTTON_SIZE)
        # ve button
